...
/* 
 *
 * User Defined Function: Porter Stemmer to get the roots of words
 *
...
// AAL: modified from original version by sprinkling some constants and casts
                              ...
                              BlockWriter &res_writer)
    {
        ...
        do {
            ...
            else 
            {
                ...
                char buf[ilen+1];
                memcpy(buf, input.data(), ilen);
                buf[ilen] = '\0'; // null terminate
            
                // stem that badboi
                int olen = stem(the_stemmer, buf, ilen-1);
                buf[olen] = '\0'; // stemmer operates in place
...
RegisterFactory(PorterStemmerFactory);
